...
import com.gujian.debitapp.databinding.AssessItemBinding;
...
public class AssessAdapter extends RecyclerView.Adapter<AssessAdapter.MyHolder> {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyHolder(DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.assess_item,parent,false));
    ...
    public static class MyHolder extends RecyclerView.ViewHolder{
        ...
        public AssessItemBinding binding;

        public MyHolder(AssessItemBinding binding) {
